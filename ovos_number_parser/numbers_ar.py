...
# Teen spellings of the SADA corpus transcripts: Saudi Broadcasting Authority
# television, "SADA - SBA & SDAIA Audio Dataset for Arabic" (2023), National Center
# for Artificial Intelligence, SDAIA. Its Hugging Face card (m6011/sada2022) says
# "The audio files were segmented and transcribed manually". The number after each
# spelling is how many times the transcripts write it as a whole word. Left out:
# حدش, the Egyptian "nobody" of ما حدش, and هداش, which the transcripts write for
# "may He guide you" (الله هداش, the feminine هداكِ with ش) in three of its four
# occurrences.
_SADA_TEENS_AR = {
    "احداعش": 11,  # 13
    "إحدعشر": 11,  # 6
...
_FUSED_TEENS_LOOKUP = _norm_map({
    ...
    **_ATTESTED_TEENS_AR, **_SADA_TEENS_AR})
